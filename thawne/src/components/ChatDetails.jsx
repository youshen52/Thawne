...
function ChatDetails({ chatDetails, isDetailsOpen, onClose }) {
    return (
                    ...
                    <img
                        ...
                        <div className="text-white">
                            <h2 className="text-lg font-semibold leading-4">Chat Details</h2>
                
                            <p className=" mt-5">Chat ID: </p>
                
                            <p className="mt-6">Chat Security:</p>
                
                        </div>
                        <div className="mt-4 flex items-center sm:justify-end">
                            <div className="flex flex-col gap-3 text-white italic">
